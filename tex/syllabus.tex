...
\documentclass[11pt]{article}
    ...
    \def\lt{<}
    % Document parameters
    \title{Python R training course - Syllabus}
...
(http://cs231n.github.io/python-numpy-tutorial/).The theory is from MIT
Opencourseware: A Gentle Introduction to Programming Using Python
(http://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-189-a-gentle-introduction-to-programming-using-python-january-iap-2011/readings/)

For the code convention : PEP 8 --- the Style Guide for Python Code
-http://pep8.orgOnline Course, code Python in your browser
...
\item
  ...
  \end{itemize}
\item
  Vector/matrix structures, \textit{numpy} library
  ...
  \end{itemize}
\item
  Python data types, File Processing, \textit{Pandas} library
